...
function(event)
    -- ConsiderTurtle(event.unit_number)
end)


-- TODO Replace checking if wandering the turtle is done with this event
...
-- TODO could speed this up by returning the distance squared (ie, don't take the square root in here)
--      and then, whatever we compare this to, square _that_ figure.
--      eg; replace "if (len(x,y) < SomeDistance) then blah blah"
--          with "if (lensquared(x,y) < SomeDistance * SomeDistance) then blah blah"
function len(a, b)
