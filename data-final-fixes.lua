  ...
  for index, ammo in pairs(currTable) do
    ...
    if boostedName then
      ...
      -- or just the ammo_type entry directly...
        ...
        if boostCopy.ammo_type and not type(boostCopy.ammo_type) == "table" then
            boostNeeded = ParseAmmoType(boostCopy.ammo_type)
        elseif boostCopy.ammo_type then
            for _, ammo_type in pairs(boostCopy.ammo_type) do
                boostNeeded = boostNeeded or ParseAmmoType(boostCopy.ammo_type)
            end
        end
